...
</asp:Content><%@ Page Title="สมาชิกกองทุน" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site2.Master" CodeBehind="ShowMember.aspx.vb" Inherits="VFMS_test2.ShowMember" %>
    ...
    <form runat="server">
            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    <div class="box">
                    <div class="box-body">
                        <dx:ASPxGridView ID="ASPxGridView2" runat="server" CssClass="table" >
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="รหัสสมาชิก" FieldName="Q_ID" ReadOnly="True"
                                    VisibleIndex="0" CellStyle-HorizontalAlign="Center" Width="8%" SortOrder="Descending">
                                    <EditCellStyle HorizontalAlign="Center">
