        ...
        <div class="box box-info">
            ...
            <div class="box-body form-horizontal ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:LinqDataSource ID="lds_Member" runat="server" ContextTypeName="VFMS_test2.vfmsDataContext"
                            Select="new (mem_id, lmem2_id)" TableName="loan_member_acc2s" EntityTypeName="">
                        </asp:LinqDataSource>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <dx:ASPxComboBox ID="cmb_Loan" ClientInstanceName="CIN_cmb_Loan" runat="server"
                            ...
                            DataSourceID="ldr_Loan" TextField="lmem2_id" ValueField="lmem2_id" EnableCallbackMode="True" CallbackPageSize="20">
                        ...
                        <asp:LinqDataSource ID="ldr_Loan" runat="server" ContextTypeName="VFMS_test2.vfmsDataContext"
                            TableName="loan_member_acc2s" Where="mem_id == @Name">
                            <WhereParameters>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <dx:ASPxLabel ID="txt_Name1" runat="server" ClientInstanceName="CIN_txt_Name" Width="170px" Font-Size="12"></dx:ASPxLabel>
                    </div>
                </div>
                <div class="form-group">
