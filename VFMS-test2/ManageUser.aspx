                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td valign="top" style="width: 35%">
                            ...
                            <asp:SqlDataSource runat="server" ID="sds_User" ConnectionString="<%$ ConnectionStrings:VFMS_test2.vfmsDataContext %>"
                        ...
                        <td valign="top" style="width: 65%">
                            ...
                            <asp:LinqDataSource ID="lds_ser" runat="server" ContextTypeName="VFMS_test2.vfmsDataContext"
